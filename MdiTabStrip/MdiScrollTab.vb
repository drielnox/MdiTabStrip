...
#Region "Constructor/Destructor"
    Sub New(ByVal owner As MdiTabStrip, ByVal scrollType As ScrollTabType)
        ...
        AddHandler owner.RightToLeftChanged, AddressOf OnOwnerRightToLeftChanged
    ...
    Protected Overrides Sub Dispose(ByVal disposing As Boolean)
        If disposing Then
            ...
            If ParentInternal IsNot Nothing Then
                RemoveHandler ParentInternal.RightToLeftChanged, AddressOf OnOwnerRightToLeftChanged
            End If
        End If
...
#Region "Paint methods"
    ...
    Private Sub DrawLeftGlyph(ByVal g As Graphics)
        Dim rect As New Rectangle(Left + ((Width / 2) - 6), Top + 13, 11, 5)
    ...
    Private Sub DrawRightGlyph(ByVal g As Graphics)
        Dim rect As New Rectangle(Left + ((Width / 2) - 5), Top + 13, 11, 5)
    ...
    Private Sub DrawChevron(ByVal g As Graphics, ByVal chevron1 As Point(), ByVal chevron2 As Point())
        ...
        Using glyphPen As New Pen(TabForeColor, 1)
            If Not Enabled Then
                Dim c As Color = ParentInternal.InactiveTabForeColor
